...
thursday = [
"",
"\\blue \\ppp{Вроде бы физика сплошных сред}{4-30}{Поляков П.А.}",
"\\blue \\ppp{Философские вопросы естествознания}{5-25}{Эрекаев В. Д.}",
"",
"\\blue \\ppp{Радиоспектро\\-скопия магн. материалов}{4-28}{Козлов В.И.}"
# "\\blue \\ppp{С/к по выбору}{Боков П.Ю.}{4-30}"
]
