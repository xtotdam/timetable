...
\tikzset{
	...
	prac325/.style={minimum height={t2f(3, 25)*\yunit}},
	% ранняя смена чуть длиннее
	prac330/.style={minimum height={t2f(3, 30)*\yunit}},
	% дистанционная пара
	dist/.style={dashed},
	% ``выключенная'' пара
...
% style = single, dist, greyedout, prac325, prac330
% day = mon, tue, wed, thu, fri, sat
% time = p1, p2, p3, p4, p5, prac1, p3fnm

\node[single, fill=blue!7] at (mon |- p1) {\textbf{Лекция}\\ Общая физика\\ 229 ФНМ};
\node[single, fill=blue!7] at (wed |- p1) {\textbf{Лекция}\\ Общая физика\\ 229 ФНМ};
\node[single, fill=yellow!7] at (thu |- p1) {\textbf{Семинар}\\ Общая физика\\ 229 ФНМ};

\node[single, fill=green!7] at (thu |- p4) {\textbf{Семинар}\\ Молекулярная физика\\ 5-25};
\node[single, fill=green!7] at (fri |- p2) {\textbf{Семинар}\\ Молекулярная физика\\ 5-52};

\node[single] at (tue |- p1) {\textbf{Лекция}\\ Молекулярная физика\\ Клавсюк А. Л.\\ СФА};
\node[single] at (sat |- p1) {\textbf{Лекция}\\ Молекулярная физика\\ Клавсюк А. Л.\\ СФА};

\node[single,prac325, fill=red!7] at (fri |- p3) {\textbf{Спецпрактикум для 3 курса}\\ 4-28 ?};
