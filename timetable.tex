...
\node[single] at (tue |- p1) {
	\textbf{Лекция}\\ Механика\\ Клавсюк А.Л.\\ СФА
};

\node[halfsize] at (tue |- p25) {
	\textbf{Лекция}\\ СФА
};

\node[prac325, very thick, fill=pink!40] at (mon |- p3) {
	\textbf{Практикум}\\[1em]Механика \\~\\~
};

\node[single, very thick, fill=green!7] at (mon |- p2) {
	\textbf{Семинар}\\ Механика\\ 5-26
};

\node[single, very thick, fill=green!7] at (thu |- p3) {
	\textbf{Семинар}\\ Механика\\ 5-27
};

\node[single, very thick, fill=green!7] at (sat |- p2) {
	\textbf{Семинар}\\ Механика\\ 5-36
};
